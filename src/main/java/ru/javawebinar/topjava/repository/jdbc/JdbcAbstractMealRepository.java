...
@Repository
//HSQLDB doesn't work with java8 time api -Arturka
public abstract class JdbcAbstractMealRepository implements MealRepository {
    ...
    //returning correct type of time for hsqldb or postgres -Arturka
    public abstract  <T> T getCorrectTime(LocalDateTime localDateTime);

...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <table class="table table-striped" id="dataMealTable">
            <thead>
            <tr>
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr data-mealExcess="${meal.excess}">
                    ...
                    <td><a class="delete" id="${meal.id}" onclick=deleteMealRow(this.id)><span
            ...
            <div class="modal-body">
                <form id="detailsMealForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="${mealUp.description}" class="form-control" id="description" name="description"
